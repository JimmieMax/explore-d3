...
// #Complete Bar Chart
{
    const height = 300
        ...
        , rectWidth = svgWidth / dataset.length - rectPadding
        //xScale
    ...
    svg.selectAll("rect")
        ...
        .attr("x", (d, i) => xScale(i) + rectPadding)
    ...
    //append xAxis
    svg.append("g")
        .attr("transform", "translate(" + (padding.left + rectWidth / 2 + rectPadding) + "," + (height - padding.bottom + 2) + ")")
        .call(xAxis);
    //append yAxis
    svg.append("g")
        .attr("transform", "translate(" + padding.left + "," + padding.top + ")")
